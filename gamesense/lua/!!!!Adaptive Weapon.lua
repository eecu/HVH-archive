...
local master_switch = ui_new_checkbox("RAGE", "aimbot", "Enable adaptive weapon")
...
for i=1, #config_names do
    rage[i] = {
        ...
        target_selection = ui_new_combobox("RAGE", "aimbot", "[" .. config_names[i] .. "] Target selection", {"Highest damage", "Cycle", "Cycle (2x)", "Near crosshair", "Best hit chance"}),
        ...
        quick_stop_options = ui_new_multiselect("RAGE", "aimbot", "[" .. config_names[i] .. "] Quick stop options", {"Early", "Slow motion", "Duck", "Fake duck", "Move between shots", "Ignore molotov", "Taser", "Jump scout"}),
        
        quick_stop_ns = ui_new_checkbox("RAGE", "aimbot", "[" .. config_names[i] .. "] Quick stop noscope"),
        quick_stop_options_ns = ui_new_multiselect("RAGE", "aimbot", "[" .. config_names[i] .. "] Quick stop options ns", {"Early", "Slow motion", "Duck", "Fake duck", "Move between shots", "Ignore molotov", "Taser", "Jump scout"}),
        
        prefer_baim = ui_new_checkbox("RAGE", "aimbot", "[" .. config_names[i] .. "] Prefer body aim"),
        prefer_baim_disablers = ui_new_multiselect("RAGE", "aimbot", "[" .. config_names[i] .. "] Prefer body aim disablers", {"Low inaccuracy", "Target shot fired", "Target resolved", "Safe point headshot"}),
...
rage[scoped_wpn_idx[1]].js_quick_stop_options = ui_new_multiselect("RAGE", "aimbot", "[Jump Scout] Quick stop options", {"Early", "Slow motion", "Duck", "Fake duck", "Move between shots", "Ignore molotov", "Taser", "Jump scout"})
rage[scoped_wpn_idx[1]].js_prefer_baim = ui_new_checkbox("RAGE", "aimbot", "[Jump Scout] Prefer body aim")
rage[scoped_wpn_idx[1]].js_prefer_baim_disablers = ui_new_multiselect("RAGE", "aimbot", "[Jump Scout] Prefer body aim disablers", {"Low inaccuracy", "Target shot fired", "Target resolved", "Safe point headshot"})
...
local on_damage_enable = ui.new_checkbox("Rage", "Other", "Hit log")
local on_damage_colour = ui.new_color_picker("Rage", "Other", "Hit log", 100, 149, 237, 255)
...
local function on_player_hurt(e)
	if ui_get(on_damage_enable) then
...
local function on_aim_miss(e)
	if ui_get(on_miss_enable) and e ~= nil then
