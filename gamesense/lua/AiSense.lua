...
local menu = {
    main_switch = ui_new_checkbox("RAGE", "Other", "Sord Ai Peek"),
    key = ui_new_hotkey("RAGE", "Other", "Peek bot key", true, 0),
    dt_peek = ui.new_hotkey('RAGE', 'Other', "DT teleport prediction",false),
    mode = ui_new_combobox("RAGE", "Other", "Ai mode", {"Risky", "Safest"}),
    target = ui_new_combobox("RAGE", "Other", "Ai target", {"Current", "All target"}),
    ...
    color = ui_new_color_picker("RAGE", "Other", "Debugger color", 255, 255, 255, 255)
}
...
client_set_event_callback("paint", function()
	...
	renderer.indicator(indr, indg, indb, inda, '   ')
        mindmg()
        aiPeekrunner()   
    end
)
