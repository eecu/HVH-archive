...
local inti = {
    ...
    configs_3 = function()
        ...
        indicator.feature_clr_3 = ui_new_color_picker(TAB[3], TAB[5], prefix(nil, "Hide").."\nPisisui Color #3", 200, 200, 200, 255)
        indicator.feature_clr_4 = ui_new_color_picker(TAB[3], TAB[5], prefix(nil, "Hide").."\nPisisui Color #4", 200, 200, 200, 255)
        indicator.feature_tbl = ui_new_multiselect(TAB[3], TAB[5], "\n Feature table", {
            "Min Damage States", "Hitchance States", "Hitbox States","Pisisui","test"
        })
...
local visible = {
    ...
    indicators = function()
        ...
        ui_set_visible(indicator.feature_clr_3, feature)
        ui_set_visible(indicator.feature_clr_4, feature)
...
local paint = {
    ...
    vanilla = function(color_1, color_2, color_3, color_4)
        ...
        local ind = {
            ...
            name = lib.contains(ui_get(indicator.feature_tbl), "Pisisui"),
            name2 = lib.contains(ui_get(indicator.feature_tbl), "test"),
        }
        local pisi = ind.name and  "Pisisui" or ""
        local weapontext = ind.name2 and "Weapon" or ""
        local Se22perate = (ind.name and ind.name2) and " " or ""
        local print_screen = g_text(color_3, color_4,pisi..Se22perate..weapontext)
...
local g_callback = {
    ...
    call = function()
        ...
        local paints_vn = function(color_1, color_2, color_3, color_4)
            local vc_enable = ui_get(indicator.feature)
            if vc_enable then paint.vanilla(color_1, color_2, color_3, color_4) end
        end
        ...
        local callback = function()
            ...
            local color = {
                ...
                vn_3 = {ui_get(indicator.feature_clr_3)},
                vn_4 = {ui_get(indicator.feature_clr_4)}
            }
            ...
            if run_feature then paints_vn(color.vn_1, color.vn_2,color.vn_3,color.vn_4) end
