...
for i=1, #config_names do
    rage[i] = {
        ...
        --accuracy_boost = ui_new_combobox("RAGE", "A", "[" .. config_names[i] .. "] Accuracy boost", {"Off", "Low", "Medium", "High", "Maximum"}),
...
rage[scoped_wpn_idx[1]].js_force_baim_peek = ui_new_checkbox("RAGE", "Aimbot", "[Jump Scout] Force body aim on peek")
...
local ref_quickstop, ref_quickstop_key, ref_quickstop_options = ui_reference("RAGE", "Aimbot", "Quick stop")
