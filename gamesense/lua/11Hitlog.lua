...
do
	enable = ui.new_checkbox("lua", "b", "Hit log")
	color = ui.new_color_picker("lua", "b", "hitlog color", 255, 255, 255, 255)
	s_offset = ui.new_slider("lua", "b", "\nHitlog offset", -500, 500, 128, true, "px")
	s_fadetime = ui.new_slider("lua", "b", "\nHitlog fade time", 1, 15, 4, true, "s")
