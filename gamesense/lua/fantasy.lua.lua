--fantasy private
print("hello im kura, discord:kurahvh QQ:2164803052") 
print("如果你喜欢 Fantasy.lua，你可以加入我的项目 Prophesy.lua https://discord.gg/5yfK9VDY7M or QQ:2164803052  如果你已经购买或有 Fantasy，你将获得 50% 的折扣")
print("别相信那个大混蛋 kozeR (spike1337)，我完成了所有 Fantasy.lua 编码，他拿走了所有的钱。 不要相信他，我会泄露Fantasy.lua源代码。 享受。 今天kozeR（spike1337）删除了fantasy.lua不和谐服务器并且没有支付我承诺的钱，然后就跑了。 他告诉我，如果我给他写一个lua，他会在中国做广告，他会给我一半的钱，但实际上他从来没有付过我钱。 我为lua做了所有的工作，他给我的只有背叛。 他试图出售fantasy.lua的源代码，现在他删除了discord并逃跑了。 别相信这个母狗 kozeR(spike1337)")
print("welcome to fantasy recode! if you have any bugs open ticket")
...
info_panel = function()
    ...
    if ui.get(fantasy.menu.watermark) == "Bottom" then
    script.renderer:glow_module(x - 60, y_offset - 40, 120, 20, 20, 3, {r, g, b, 150}, {255, 255, 255,0})
    roundedRectangle(x - renderer.measure_text("", "discord.gg/fantasylua")/2 - 2, y_offset - 35, renderer.measure_text("", "discord.gg/fantasylua") + 4, 10, 23,23,23,240,"", 7)
    renderer.text(x, y_offset - 30, 255,255,255, 255, 'c', nil, "discord.gg/" .. text_fade_animation(8, r,g,b, 255, "fantasylua"))
    renderer.gradient(x, y_offset - 43, renderer.measure_text("", "discord.gg/fantasylua")/2 + 5, 2, r, g, b, 150, r, g, b, 10, true)
    renderer.gradient(x, y_offset - 43, -renderer.measure_text("", "discord.gg/fantasylua")/2 - 5, 2, r, g, b, 150, r, g, b, 10, true)
    end
    
    if ui.get(fantasy.menu.watermark) == "Side" then
    renderer.text(10, y - 15, 100,100,100, 255, '', nil, "F A N T A S Y")
    renderer.text(10, y - 15, 255,255,255, 255, '', nil, text_fade_animation(8, r,g,b, 255, "F A N T A S Y") .. "\aFFFFFFFF [PRIVATE]")
    end
